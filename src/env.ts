...
export const env: Env = {
  ...
  SUPABASE_ANON_KEY:
    processEnv.SUPABASE_ANON_KEY || defaultEnv.SUPABASE_ANON_KEY,
  NEXT_PUBLIC_USE_MOCK_AI:
    processEnv.NEXT_PUBLIC_USE_MOCK_AI || defaultEnv.NEXT_PUBLIC_USE_MOCK_AI,
  NEXT_PUBLIC_OPENAI_API_KEY: processEnv.NEXT_PUBLIC_OPENAI_API_KEY,
  SUPABASE_STORAGE_BUCKET:
    processEnv.SUPABASE_STORAGE_BUCKET || defaultEnv.SUPABASE_STORAGE_BUCKET,
};
