...
describe('班级服务测试', () => {
  ...
  describe('getAllClasses', () => {
    ...
    it('获取班级失败时返回空数组并显示错误提示', async () => {
      ...
      expect(supabase.from).toHaveBeenCalledWith('classes');
      expect(toast.error).toHaveBeenCalledWith(`获取班级列表失败: ${mockError.message}`);
  ...
  describe('getClassById', () => {
    ...
    it('获取班级详情失败时返回null并显示错误提示', async () => {
      ...
      expect(supabase.from).toHaveBeenCalledWith('classes');
      expect(toast.error).toHaveBeenCalledWith(`获取班级详情失败: ${mockError.message}`);
  ...
  describe('createClass', () => {
    ...
    it('创建班级失败时返回null并显示错误提示', async () => {
      ...
      expect(supabase.from).toHaveBeenCalledWith('classes');
      expect(toast.error).toHaveBeenCalledWith(`创建班级失败: ${mockError.message}`);
      expect(result).toBeNull();
    });
  });
