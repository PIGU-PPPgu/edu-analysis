...
export const ADAPTED_DATABASE_FIELDS = {
  ...
  scores: {
    ...
    english_score: {
      ...
      type: "number",
      range: [0, 150],
      dbColumn: "custom_1d8d05c1-e4d7-4c79-ab48-f3063656be90",
    },
    physics_score: {
      name: "物理分数",
      type: "number",
      range: [0, 150],
      dbColumn: "custom_c316f6bf-684e-4d2a-b510-2ab1e33911e2",
    },
    chemistry_score: {
      name: "化学分数",
      type: "number",
      range: [0, 150],
      dbColumn: "custom_0afe3098-4bc1-498f-8b66-9cdc19039acf",
    },
    biology_score: {
      name: "生物分数",
      type: "number",
      range: [0, 150],
      dbColumn: "custom_eb526d63-5745-48af-ab96-02e4820bbf36",
    },
    politics_score: {
      name: "政治分数",
      type: "number",
      range: [0, 150],
      dbColumn: "custom_df6ffec1-7cc9-47e8-8273-a06c5b852382",
    },
    history_score: {
      name: "历史分数",
      type: "number",
      range: [0, 150],
      dbColumn: "custom_95a679a2-a689-4cd2-8e6d-74569b8fa325",
    },
    geography_score: {
      name: "地理分数",
      type: "number",
      range: [0, 150],
      dbColumn: "custom_7433e86d-1005-478d-9923-1bff62e1e16e",
    },
  },
...
export class AdaptedIntelligentFieldValidator {
  ...
  analyzeField(header, sampleData) {
    ...
    // 科目识别
    for (const [subjectKey, subjectInfo] of Object.entries(
      ADAPTED_SUBJECT_PATTERNS
    )) {
