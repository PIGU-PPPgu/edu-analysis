    ...
    switch (type) {
      case 'loading':
        return {
          ...
          cardClassName: 'bg-gradient-to-r from-blue-50 to-indigo-50 border-blue-200',
      ...
      case 'success':
        return {
          ...
          cardClassName: 'bg-gradient-to-r from-green-50 to-emerald-50 border-green-200',
      ...
      case 'error':
        return {
          ...
          cardClassName: 'bg-gradient-to-r from-red-50 to-pink-50 border-red-200',
      ...
      case 'warning':
        return {
          ...
          cardClassName: 'bg-gradient-to-r from-amber-50 to-yellow-50 border-amber-200',
      ...
      case 'info':
        return {
          ...
          cardClassName: 'bg-gradient-to-r from-blue-50 to-cyan-50 border-blue-200',
          titleClassName: 'text-blue-700',
        ...
        <div className="text-center">
          <div className={cn('flex flex-col items-center', sizeConfig.spacing)}>
            ...
            <div className="relative">
              <Icon className={cn(typeConfig.iconClassName, sizeConfig.iconSize)} />
              {type === 'loading' && (
            ...
            <div className="space-y-2">
              <p className={cn(sizeConfig.titleSize, typeConfig.titleClassName)}>
                {title}
              </p>
              {description && (
                <p className={cn(sizeConfig.descriptionSize, typeConfig.descriptionClassName, 'max-w-md')}>
                  {description}
                </p>
              )}
            </div>
