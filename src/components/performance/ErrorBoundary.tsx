  ...
  render() {
    if (this.state.hasError) {
      ...
      const severity = errorDetails
        ? this.assessErrorSeverity(errorDetails.error)
        : "medium";
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                        <div>
                          ...
                          <ul className="space-y-1 text-[#6B7280]">
                            ...
                            <li>
                              构建版本: {errorDetails.buildVersion || "Unknown"}
                            </li>
                          </ul>
                        </div>
                        ...
                        <div>
                          ...
                          <ul className="space-y-1 text-[#6B7280]">
                            <li>
                              用户ID: {errorDetails.userId || "Anonymous"}
                            </li>
                            <li>
                              会话ID: {errorDetails.sessionId || "Unknown"}
                            </li>
