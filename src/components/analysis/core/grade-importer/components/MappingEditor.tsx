...
const MappingEditor: React.FC<MappingEditorProps> = ({
  ...
  // 检查是否有变更
  const hasChanges =
    JSON.stringify(currentMapping) !== JSON.stringify(originalMapping);
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                考试: {examInfo.title} | 日期: {examInfo.date} | 记录数:{" "}
                {examInfo.total_records}
              </CardDescription>
            </div>
                  ...
                  >
                    ...
                    <div className="w-64">
                      <Select
                        value={mappedField}
                        onValueChange={(value) =>
                          handleMappingChange(originalField, value)
                        }
                      >
                        <SelectTrigger>
                          <SelectValue />
        ...
        <TabsContent value="preview">
          <Card>
            <CardHeader>
              ...
              <CardDescription>查看当前映射下的数据解释效果</CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  {mappingHistory.map((history) => (
                    <div key={history.id} className="p-3 border rounded">
                      <div className="flex justify-between items-start">
                        ...
                        <Badge variant="outline">{history.changed_by}</Badge>
                      </div>
                    </div>
                  ))}
                </div>
