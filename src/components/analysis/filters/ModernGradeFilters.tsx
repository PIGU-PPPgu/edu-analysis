...
const ModernGradeFilters: React.FC<ModernGradeFiltersProps> = ({
  ...
  const updateFilter = useCallback(
    (updates: Partial<GradeFilterConfig>) => {
  ...
  const removeFilter = useCallback(
    (filterKey: keyof GradeFilterConfig) => {
          ...
          <div className="flex flex-wrap gap-2">
            {filter.examIds?.map((examId) => {
              ...
              return exam ? (
                <Badge
                  key={examId}
                  className="bg-[#B9FF66] text-[#191A23] border-2 border-black font-bold shadow-[2px_2px_0px_0px_#191A23] hover:translate-x-[-1px] hover:translate-y-[-1px] hover:shadow-[3px_3px_0px_0px_#191A23] transition-all cursor-pointer"
                >
                  {exam.title}
                  <X
            ...
            {filter.subjects?.map((subject) => (
              <Badge
                key={subject}
                className="bg-[#F7931E] text-white border-2 border-black font-bold shadow-[2px_2px_0px_0px_#191A23] hover:translate-x-[-1px] hover:translate-y-[-1px] hover:shadow-[3px_3px_0px_0px_#191A23] transition-all cursor-pointer"
              >
                {subject}
                <X
                  className="w-3 h-3 ml-2 hover:text-[#FF6B6B] transition-colors"
            ...
            {filter.classNames?.map((className) => (
              <Badge
                key={className}
                className="bg-[#9C88FF] text-white border-2 border-black font-bold shadow-[2px_2px_0px_0px_#191A23] hover:translate-x-[-1px] hover:translate-y-[-1px] hover:shadow-[3px_3px_0px_0px_#191A23] transition-all cursor-pointer"
              >
                {className}
                <X
                  className="w-3 h-3 ml-2 hover:text-[#FF6B6B] transition-colors"
                  onClick={() =>
                    updateFilter({
                      classNames: filter.classNames?.filter(
                        (c) => c !== className
                      ),
                    })
                  }
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
              ...
              <div className="flex gap-2">
                <div className="flex-1 min-w-0">
                  <Select
                    ...
                    onValueChange={(value) =>
                      updateFilter({ examIds: value === "all" ? [] : [value] })
                    }
                  >
            ...
            <div className="space-y-3">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  updateFilter({ subjects: value === "all" ? [] : [value] })
                }
              >
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
            ...
            <div className="space-y-3">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  updateFilter({ classNames: value === "all" ? [] : [value] })
                }
              >
            ...
            <div className="space-y-3">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  updateFilter({ grades: value === "all" ? [] : [value] })
                }
              >
