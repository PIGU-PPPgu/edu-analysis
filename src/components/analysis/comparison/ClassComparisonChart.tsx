...
export default function ClassComparisonChart({
  ...
  return (
    <Card className={`bg-white border-2 border-black shadow-[6px_6px_0px_0px_#B9FF66] transition-all hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[8px_8px_0px_0px_#B9FF66] ${className}`}>
      ...
      <CardContent className="p-6">
        ...
        {chartType === 'radar' && (
          <div className="space-y-6">
            <h3 className="text-xl font-black text-[#191A23] uppercase tracking-wide">🔄 多科目雷达对比图</h3>
                ...
                <div className="h-96">
                  <ResponsiveContainer width="100%" height="100%">
                    <RadarChart data={radarData}>
                      ...
                      <PolarRadiusAxis 
                        domain={[0, 100]} 
                        tick={{ fontSize: 10, fontWeight: 'bold', fill: '#191A23' }}
                        tickCount={6}
                        stroke="#191A23"
                      />
                          ...
                          return (
                            <Card
                              ...
                              className={`border-2 border-black shadow-[2px_2px_0px_0px_#191A23] transition-all hover:translate-x-[-1px] hover:translate-y-[-1px] hover:shadow-[3px_3px_0px_0px_#191A23] ${
                                isAboveAverage ? 'bg-[#B9FF66]/20' : 'bg-[#F3F3F3]'
                              }`}
                            >
                              <CardContent className="p-4">
                                <div className="flex items-center justify-between">
                                  <div className="flex items-center gap-4">
                                    <div className={`w-10 h-10 rounded-full flex items-center justify-center text-white font-black text-lg border-2 border-black ${
                                      index === 0 ? 'bg-[#B9FF66] shadow-[2px_2px_0px_0px_#191A23]' :
                                  ...
                                  <div className="text-right">
                                    <div className="font-black text-[#191A23] text-xl mb-1">{item.average.toFixed(1)}</div>
                                    <Badge className={`font-bold shadow-[2px_2px_0px_0px_#191A23] border-2 border-black ${
                                      isAboveAverage ? 'bg-[#B9FF66] text-[#191A23]' : 'bg-[#B9FF66] text-white'
                                    }`}>
