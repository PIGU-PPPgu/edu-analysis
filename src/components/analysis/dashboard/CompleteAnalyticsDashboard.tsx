  ...
  return (
    <Card
      className={cn(
        ...
        isActive
          ? "shadow-[6px_6px_0px_0px_#191A23]"
      ...
      <CardContent className="p-6">
        <div className="space-y-4">
          <div className="flex items-center gap-3">
            <div
              className={cn(
                "p-3 rounded-full border-2 border-black",
                module.color
              )}
            >
            ...
            <Card className="border-2 border-black shadow-[6px_6px_0px_0px_#B9FF66]">
              <CardHeader className="bg-[#B9FF66] border-b-2 border-black">
                <CardTitle className="text-[#191A23] font-black">
                  {
                    ANALYSIS_MODULES[
                      activeModule as keyof typeof ANALYSIS_MODULES
                    ].title
                  }{" "}
                  - 预览
                </CardTitle>
        ...
        <TabsContent value="behavior" className="space-y-6">
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
            ...
            <Card className="border-2 border-black shadow-[6px_6px_0px_0px_#B9FF66]">
              ...
              <CardContent className="p-6">
                <AbilityRadar studentId="" subjects={availableSubjects} />
              </CardContent>
            </Card>
          </div>
        </TabsContent>
