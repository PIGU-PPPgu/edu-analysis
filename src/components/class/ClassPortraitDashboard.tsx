...
export function ClassPortraitDashboard({
  ...
  const loadClassPortrait = async () => {
    ...
    try {
      const portrait =
        await intelligentPortraitService.generateClassPortrait(className);
      if (portrait) {
  ...
  const studentDistributionData = [
    ...
    },
    {
      name: "待提升学生",
      value:
        classPortrait.class_characteristics.academic_distribution.needs_support,
      color: "#EF4444",
    },
  ];
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <div className="flex items-center gap-2">
                        <Progress
                          value={
                            classPortrait.class_characteristics
              ...
              {classPortrait.group_analysis.current_groups.length > 0 ? (
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      {classPortrait.group_analysis.current_groups.map(
                        (group, index) => (
                          <div
                            key={group.group_id}
                              ...
                              <div className="text-sm">
                                ...
                                <span
                                  className={`font-medium ${
                                    group.group_dynamics.cohesion_score > 80
                                      ? "text-green-600"
                                      : group.group_dynamics.cohesion_score > 60
                                        ? "text-yellow-600"
                                        : "text-red-600"
                                  }`}
                                >
                ...
                <div className="text-center text-muted-foreground py-8">
                  ...
                  <p className="text-sm mt-2">
                    建议创建{classPortrait.group_analysis.optimal_group_count}
                    个学习小组
                  </p>
                </div>
              )}
            ...
            <TabsContent value="recommendations" className="space-y-4">
              ...
              <div className="space-y-4">
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      {classPortrait.teaching_recommendations.differentiated_instruction.map(
                        (suggestion, index) => (
                          <div
                            key={index}
                      ...
                      {classPortrait.teaching_recommendations
                        .differentiated_instruction.length === 0 && (
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      {classPortrait.teaching_recommendations.group_activity_suggestions.map(
                        (suggestion, index) => (
                          <div
                            key={index}
                      ...
                      {classPortrait.teaching_recommendations
                        .group_activity_suggestions.length === 0 && (
                        <p className="text-sm text-muted-foreground">
                          暂无特定的小组活动建议
                        </p>
                      )}
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      {classPortrait.teaching_recommendations.individual_attention_priorities.map(
                        (priority, index) => (
                          <div
                            key={index}
                      ...
                      {classPortrait.teaching_recommendations
                        .individual_attention_priorities.length === 0 && (
                        <p className="text-sm text-muted-foreground">
                          暂无特定的个别指导建议
                        </p>
                      )}
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      {classPortrait.teaching_recommendations.class_management_tips.map(
                        (tip, index) => (
                          <div
                            key={index}
                      ...
                      {classPortrait.teaching_recommendations
                        .class_management_tips.length === 0 && (
                        <p className="text-sm text-muted-foreground">
                          暂无特定的班级管理建议
                        </p>
                      )}
              ...
              <CardContent>
                <div className="space-y-3 text-sm">
                  ...
                  <p>
                    ...
                    {classPortrait.group_analysis.current_groups.length}
                    个学习小组， 建议设置
                    {classPortrait.group_analysis.optimal_group_count}个小组。
                    协作准备度为
                    {
                      classPortrait.class_characteristics
                        .collaboration_readiness
