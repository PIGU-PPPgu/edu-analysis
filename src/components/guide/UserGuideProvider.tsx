...
interface GuideContextType {
  ...
  completeTour: () => void;
  updatePreferences: (
    preferences: Partial<GuideState["userPreferences"]>
  ) => void;
    ...
    steps: [
      {
        ...
        title: "欢迎使用预警系统",
        content:
          "预警系统通过分析学生数据，及时发现潜在风险，帮助教师制定针对性干预措施。让我们一起了解系统的主要功能。",
      ...
      },
      {
        ...
        title: "统计概览",
        content:
          "这里显示了学校的整体预警情况，包括总学生数、风险学生数和预警比例。这些数据基于实时分析生成。",
        target: ".stat-cards",
        position: "bottom",
        action: "wait",
        nextTrigger: "manual",
      ...
      },
      {
        ...
        title: "功能导航",
        content:
          "系统分为五个主要模块：概览分析、预警列表、引擎控制、预警规则和数据同步。每个模块都有特定的功能。",
        target: ".warning-tabs",
        position: "bottom",
        action: "wait",
        nextTrigger: "manual",
      ...
      },
      {
        ...
        title: "筛选器",
        content:
          "使用筛选器可以按时间范围、风险等级、预警状态等条件精确查看数据。点击筛选器按钮试试。",
    ...
    steps: [
      {
        ...
        title: "风险级别分布",
        content:
          "此图表显示不同风险等级学生的分布情况。红色代表高风险，橙色代表中风险，绿色代表低风险。",
      ...
      },
      {
        ...
        title: "风险因素分析",
        content:
          "这里展示了导致学生预警的主要因素，如成绩下滑、出勤问题等。帮助识别需要重点关注的问题。",
      ...
      },
      {
        ...
        title: "班级风险分布",
        content:
          "查看各班级的风险学生比例，有助于识别需要特别关注的班级。进度条长度表示风险程度。",
      ...
      },
      {
        ...
        title: "预警类型统计",
        content:
          "了解不同类型预警的分布情况：学业预警、行为预警、出勤预警和作业预警。有助于制定针对性措施。",
    ...
    steps: [
      {
        ...
        title: "预警引擎介绍",
        content:
          "预警引擎是系统的核心，负责执行预警规则、生成预警记录。它可以手动执行或自动运行。",
      ...
      },
      {
        ...
        title: "手动执行规则",
        content:
          '点击"执行预警规则"按钮可以立即执行所有激活的预警规则。建议在数据更新后执行。',
      ...
      },
      {
        ...
        title: "查看执行结果",
        content:
          "执行完成后，这里会显示处理的学生数量、触发的预警数量和执行统计。",
    ...
    steps: [
      {
        ...
        title: "预警规则概览",
        content:
          "预警规则定义了什么情况下系统会产生预警。系统包含多种预设规则，也支持自定义规则。",
        target: ".rules-list",
        position: "bottom",
        action: "wait",
        nextTrigger: "manual",
      ...
      },
      {
        ...
        title: "创建新规则",
        content:
          '点击"创建规则"按钮可以添加自定义预警规则。可以设置触发条件、严重程度等参数。',
      ...
      },
      {
        ...
        title: "使用模板",
        content:
          '系统提供了常用的规则模板，如"连续不及格预警"、"成绩下降预警"等，可以直接使用或修改。',
...
export function UserGuideProvider({ children }: UserGuideProviderProps) {
  ...
  const canStartTour = (tourId: string): boolean => {
    ...
    return tour.prerequisites.every((prereq) =>
      state.completedTours.includes(prereq)
    );
  };
