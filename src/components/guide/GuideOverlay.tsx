...
export function GuideOverlay() {
  const { state, tours, nextStep, previousStep, stopTour, skipTour } =
    useGuide();
  ...
  const handleActionClick = () => {
    ...
    if (
      ...
      currentStep?.nextTrigger === "element"
    ) {
        ...
        <CardHeader className="pb-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <Badge
                variant="outline"
                className="border-[#c0ff3f] text-[#c0ff3f]"
              >
              ...
              <Badge
                ...
                className={cn(
                  "text-xs",
                  currentStep.category === "basic" &&
                    "bg-green-100 text-green-800",
                  currentStep.category === "intermediate" &&
                    "bg-yellow-100 text-yellow-800",
                  currentStep.category === "advanced" &&
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center justify-between text-xs text-gray-500 pt-2 border-t">
            <div className="flex items-center gap-4">
              ...
              <span className="flex items-center gap-1">
                <Clock className="h-3 w-3" />约 {currentTour.estimatedTime} 分钟
              </span>
            </div>
