...
import {
  runWarningDataIntegration,
  IntegrationReport,
  DataIntegrationFilters,
} from "@/services/warningDataIntegration";
...
const DataIntegrationControl: React.FC<DataIntegrationControlProps> = ({
  onDataUpdated,
  filters,
}) => {
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                ...
                <div className="text-center">
                  <div className="flex items-center justify-center mb-1">
                    ...
                    <span className="text-lg font-bold text-gray-800">
                      {lastReport.riskFactorsIdentified}
                    </span>
                  </div>
                  ...
                  <div className="space-y-1">
                    ...
                    {lastReport.errors.length > 3 && (
                      <p className="text-xs text-yellow-600">
                        ...还有{lastReport.errors.length - 3}个警告
                      </p>
                    )}
                  </div>
                </div>
