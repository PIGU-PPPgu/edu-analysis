...
import { Calendar, Search, Filter, Clock, BookOpen, BarChart3, RefreshCw, CheckCircle2 } from 'lucide-react';
import { getExams, getExamTypes, getRecentExams, type Exam, type ExamType, type ExamFilter } from '@/services/examService';
...
const ExamSelector: React.FC<ExamSelectorProps> = ({
  ...
  const filteredExams = useMemo(() => {
    if (!searchTerm && !filter.type && !filter.subject && !filter.dateFrom && !filter.dateTo) {
      return exams;
    }
    return exams;
        ...
        {showFilters && (
          <div className="p-4 bg-gray-50 rounded-lg space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <div>
                <Label htmlFor="examType" className="text-sm font-medium">考试类型</Label>
                <Select
                  value={filter.type || ""}
              ...
              <div>
                <Label htmlFor="subject" className="text-sm font-medium">科目</Label>
                <Select
              ...
              <div>
                <Label htmlFor="dateFrom" className="text-sm font-medium">起始日期</Label>
                <Input
                  id="dateFrom"
                  type="date"
              ...
              <div>
                <Label htmlFor="dateTo" className="text-sm font-medium">结束日期</Label>
                <Input
                  id="dateTo"
                  type="date"
                  value={filter.dateTo || ""}
