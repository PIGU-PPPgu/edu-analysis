...
// 预设的按钮组合
export const MobilePrimaryButton = forwardRef<
  HTMLButtonElement,
  Omit<MobileButtonProps, "variant">
>((props, ref) => <MobileButton ref={ref} variant="primary" {...props} />);

export const MobileSecondaryButton = forwardRef<
  HTMLButtonElement,
  Omit<MobileButtonProps, "variant">
>((props, ref) => <MobileButton ref={ref} variant="secondary" {...props} />);

export const MobileFloatingActionButton = forwardRef<
  HTMLButtonElement,
  Omit<MobileButtonProps, "variant" | "size">
>((props, ref) => (
  <MobileButton ref={ref} variant="fab" size="icon" elevation={3} {...props} />
));

export const MobileIconButton = forwardRef<
  HTMLButtonElement,
  Omit<MobileButtonProps, "size">
