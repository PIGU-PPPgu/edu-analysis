...
export const DEFAULT_PROVIDERS: Record<string, ProviderConfig> = {
  ...
  'sbjt': {
    ...
    authType: 'bearer',
    models: [
      { id: 'deepseek-ai/DeepSeek-V3', name: 'DeepSeek-V3', maxTokens: 8192, supportStream: true },
      { id: 'deepseek-ai/DeepSeek-Coder', name: 'DeepSeek Coder', maxTokens: 8192, supportStream: true },
    ],
    requestFormat: (params, model) => ({
      model: model,
      messages: params.messages,
  ...
  'doubao': {
    ...
    authType: 'bearer',
    models: [
      { id: 'doubao-lite-128k', name: '豆包 Lite (128k)', maxTokens: 4096, supportStream: true, contextWindow: 131072, endpointPath: '/chat/completions' },
      { id: 'doubao-1-5-vision-pro-32k-250115', name: '豆包视觉模型 (Pro 32k)', maxTokens: 2048, supportStream: false, contextWindow: 32768, endpointPath: '/chat/completions' },
      { id: 'bot-20250429000553-tlhdg', name: '豆包文本Bot (示例)', maxTokens: 4096, supportStream: true, contextWindow: 32768, endpointPath: '/bots/chat/completions' }
    ],
    requestFormat: (params, model) => ({
      model: model,
      messages: params.messages,
