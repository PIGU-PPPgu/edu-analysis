...
export const useTouch = (
  ...
  const emitGesture = useCallback(
    (gesture: TouchGesture, additionalData?: Partial<TouchEventData>) => {
  ...
  const handleTouchEnd = useCallback(
    (e: React.TouchEvent) => {
      ...
      // 滑动手势检测
      if (
        absDeltaX > finalConfig.swipeThreshold ||
        absDeltaY > finalConfig.swipeThreshold
      ) {
