                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Slider
                      ...
                      onValueChange={(values) => setModelConfig({...modelConfig, temperature: values[0]})}
                    />
                  ...
                  <div className="space-y-2">
                    ...
                    <Slider
                      ...
                      onValueChange={(values) => setModelConfig({...modelConfig, maxTokens: values[0]})}
                    />
                    <div className="flex justify-between text-xs text-muted-foreground">
                      <span>简短回答</span>
                      <span>详细回答</span>
                ...
                <CardContent className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                      ...
                      <Button variant="outline" onClick={handleTestApiKey} disabled={isLoading}>
                        测试
                      </Button>
                    </div>
                  ...
                  <div className="space-y-4 border-t pt-4">
                    ...
                    <dl className="space-y-2 text-sm">
                      <div>
                        ...
                        <dd className="text-muted-foreground">选择不同的AI服务提供商，每个提供商可能有不同的模型和API格式。</dd>
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <dd className="text-muted-foreground">控制生成内容的创造性和随机性。较低值生成更精确的回答，较高值生成更创造性的回答。</dd>
                      </div>
                      <div>
                        <dt className="font-medium">最大Token数</dt>
                        <dd className="text-muted-foreground">控制生成内容的最大长度。数值越大，生成的回答越详细，但费用也越高。</dd>
                      </div>
                    </dl>
                  </div>
