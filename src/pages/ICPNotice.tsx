          ...
          <div className="space-y-8">
            <section className="bg-blue-50 border border-blue-200 rounded-lg p-6">
              ...
              <div className="space-y-4 text-blue-800">
                <p className="text-lg font-medium">
                  本网站为
                  <strong class="text-red-600">非商业性个人工作工具</strong>
                  ，仅供本人工作使用。
                </p>
                <ul className="list-disc pl-6 space-y-2">
                  <li>
                    <strong>使用性质</strong>：个人工作辅助工具
                  </li>
                  <li>
                    <strong>访问范围</strong>：仅限开发者个人使用
                  </li>
                  <li>
                    <strong>商业目的</strong>：无任何商业行为
                  </li>
                  <li>
                    <strong>数据性质</strong>：测试数据，非真实学生信息
                  </li>
                </ul>
              </div>
            </section>
            ...
            <section className="bg-green-50 border border-green-200 rounded-lg p-6">
              ...
              <div className="space-y-4 text-green-800">
                ...
                <p className="leading-relaxed">
                  本网站开发的主要目的是<strong>方便个人工作</strong>
                  ，作为教育数据分析的研究和开发工具。
            ...
            <section className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
              ...
              <div className="space-y-4 text-yellow-800">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>
                    <strong>安全措施</strong>：采用加密存储和传输，确保数据安全
                  </li>
                  <li>
                    <strong>合规承诺</strong>：如需对外开放，将重新申请相应许可
                  </li>
                </ul>
              </div>
            </section>
            ...
            <section className="bg-gray-50 border border-gray-200 rounded-lg p-6">
              ...
              <div className="space-y-3 text-gray-700">
                ...
                <p>
                  <strong>备案类型</strong>：个人网站备案（非经营性）
                </p>
              </div>
            </section>
            ...
            <div className="text-center mt-8 p-6 bg-gray-100 rounded-lg">
              <p className="text-gray-600">
                <strong>ICP备案号</strong>：粤ICP备2025392229号
                <br />
                <strong>备案时间</strong>：2025年1月
                <br />
