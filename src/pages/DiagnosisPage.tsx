...
export const DiagnosisPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const tailwindWorking = tailwindStyles.backgroundColor === 'rgb(239, 68, 68)';
  ...
  const TestCard = ({ title, status, description }: { title: string; status: boolean; description: string }) => (
    <div style={{
    ...
    <div style={{ 
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto' }}>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm mb-6">
          <h2 className="text-xl font-bold mb-4 text-gray-700">Tailwind CSS 测试</h2>
          
          <div className="space-y-4">
            <div className="flex gap-2">
              <div className="px-3 py-2 bg-blue-500 text-white rounded">蓝色按钮</div>
              <div className="px-3 py-2 bg-green-500 text-white rounded">绿色按钮</div>
              <div className="px-3 py-2 bg-red-500 text-white rounded">红色按钮</div>
            </div>
        ...
        <div style={{
          ...
          <div style={{ backgroundColor: '#f3f4f6', padding: '16px', borderRadius: '8px', marginBottom: '16px' }}>
            <h3 style={{ fontSize: '16px', fontWeight: 'bold', marginBottom: '8px', color: '#374151' }}>
              常见问题:
            </h3>
            <ul style={{ paddingLeft: '20px', margin: 0, color: '#6b7280' }}>
              <li style={{ marginBottom: '4px' }}>如果只看到文字没有样式，可能是CSS加载问题</li>
              <li style={{ marginBottom: '4px' }}>如果页面空白，检查浏览器控制台是否有JavaScript错误</li>
              <li style={{ marginBottom: '4px' }}>如果Tailwind不工作，检查tailwind.config.ts配置</li>
              <li style={{ marginBottom: '4px' }}>如果组件异常，检查shadcn/ui组件安装</li>
            </ul>
          </div>
          ...
          <div style={{ backgroundColor: '#ecfdf5', padding: '16px', borderRadius: '8px', border: '1px solid #d1fae5' }}>
            ...
            <ol style={{ paddingLeft: '20px', margin: 0, color: '#047857' }}>
              <li style={{ marginBottom: '4px' }}>重新启动开发服务器: <code>npm run dev</code></li>
              <li style={{ marginBottom: '4px' }}>清除缓存: <code>rm -rf node_modules package-lock.json && npm install</code></li>
