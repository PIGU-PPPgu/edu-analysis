...
export const getHomeworkSubmissionsByStudentId = (studentId: string) => {
  ...
  for (const homework of homeworks) {
    const submission = homework.homework_submission.find(
    ...
    getHomeworkById: async (id: string) => {
      const homeworks = [
        ...
        },
        {
          ...
          title: "Node.js API开发",
          description:
            "使用Express框架创建一个简单的REST API，包含GET和POST请求处理。\n\n要求：\n1. 创建至少3个API端点\n2. 实现基本的数据验证\n3. 使用中间件处理错误\n4. 编写API文档",
          due_date: "2023-12-30",
          created_at: "2023-12-15",
            ...
            knowledge_point_evaluation: [
              {
                ...
                mastery_level: 85,
                knowledge_points: { id: "kp1", name: "变量声明" },
              },
              {
                id: "ke2",
                knowledge_point_id: "kp2",
                mastery_level: 70,
                knowledge_points: { id: "kp2", name: "条件语句" },
              },
              {
                id: "ke3",
                knowledge_point_id: "kp3",
                mastery_level: 90,
                knowledge_points: { id: "kp3", name: "函数定义" },
              },
            ],
          },
          {
            ...
            knowledge_point_evaluation: [
              {
                ...
                mastery_level: 95,
                knowledge_points: { id: "kp4", name: "数组方法" },
              },
              {
                id: "ke5",
                knowledge_point_id: "kp5",
                mastery_level: 90,
                knowledge_points: { id: "kp5", name: "ES6语法" },
              },
            ],
          },
          {
            ...
            knowledge_point_evaluation: [
              {
                ...
                mastery_level: 85,
                knowledge_points: { id: "kp6", name: "React Hooks" },
              },
              {
                id: "ke7",
                knowledge_point_id: "kp7",
                mastery_level: 75,
                knowledge_points: { id: "kp7", name: "组件设计" },
              },
              {
                id: "ke8",
                knowledge_point_id: "kp8",
                mastery_level: 90,
                knowledge_points: { id: "kp8", name: "JSX语法" },
              },
            ],
          },
          {
        ...
        "1": [
          {
            id: "kp1",
            name: "变量声明",
            description: "学习如何使用var, let, const声明变量",
          },
          {
            id: "kp2",
            name: "条件语句",
            description: "if-else, switch等条件语句的使用",
          },
        ...
        "2": [
          {
            id: "kp4",
            name: "数组方法",
            description: "数组的常用方法如filter, map, reduce",
          },
        ...
        "3": [
          {
            id: "kp6",
            name: "React Hooks",
            description: "React函数组件中的Hooks使用",
          },
          {
            id: "kp7",
            name: "组件设计",
            description: "React组件的设计原则与实践",
          },
        ...
        "4": [
          {
            id: "kp9",
            name: "Express框架",
            description: "Express框架基础与路由",
          },
          { id: "kp10", name: "REST API", description: "REST API设计规范" },
          {
            id: "kp11",
            name: "中间件",
            description: "Express中间件开发与使用",
          },
        ],
        "5": [
          {
            id: "kp12",
            name: "用户认证",
            description: "用户登录与认证系统实现",
          },
          {
            id: "kp13",
            name: "数据库操作",
            description: "MongoDB/MySQL数据库操作",
          },
          {
            id: "kp14",
            name: "前后端交互",
            description: "前后端数据交互与API对接",
          },
        ],
      };
...
// AI知识点分析模拟函数
export async function mockAiAnalysis(
  content: string,
  ...
  const numberOfPointsToReturn = Math.max(
    1,
    Math.min(5, Math.floor(contentLength / 100))
  );
  ...
  const existingKnowledgePointsMatched = existingKnowledgePoints
    .filter((kp) => {
      ...
      return keywords.some(
        (keyword) => keyword.includes(name) || name.includes(keyword)
      );
    })
    .map((kp) => ({
      ...kp,
  ...
  if (result.knowledgePoints.length < numberOfPointsToReturn) {
    ...
    const remainingKnowledgePoints = knowledgePointsLibrary.filter(
      (kp) => !existingNames.has(kp.name)
    );

    // 随机选择剩余所需数量的知识点
    const additionalNeeded =
      numberOfPointsToReturn - result.knowledgePoints.length;
