...
export class DataExporter {
  ...
  static exportToExcel(
    ...
    try {
      ...
      // 生成文件名
      const finalFileName =
        fileName || this.generateFileName(title, "xlsx", includeTimestamp);
  ...
  static exportToCSV(
    ...
    try {
      ...
      // 生成文件名
      const finalFileName =
        fileName || this.generateFileName(title, "csv", includeTimestamp);
  ...
  static exportToPDF(
    ...
    try {
      ...
      // 生成文件名
      const finalFileName =
        fileName || this.generateFileName(title, "pdf", includeTimestamp);
  ...
  static exportToJSON(
    ...
    try {
      ...
      // 生成文件名
      const finalFileName =
        fileName || this.generateFileName(title, "json", includeTimestamp);
