...
export const STATE_TRANSITIONS: Record<DataFlowState, DataFlowState[]> = {
  [DataFlowState.IDLE]: [DataFlowState.QUEUED, DataFlowState.VALIDATING],

  [DataFlowState.QUEUED]: [DataFlowState.VALIDATING, DataFlowState.CANCELLED],
  ...
  [DataFlowState.PAUSED]: [DataFlowState.RESUMING, DataFlowState.CANCELLED],

  [DataFlowState.RESUMING]: [DataFlowState.PROCESSING, DataFlowState.FAILED],
